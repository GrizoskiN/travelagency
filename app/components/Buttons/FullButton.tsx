...
const FullButton: FC<FullButtonProps> = ({ text, link }) => {
  return (
    <Link href={link}>
      <div className="text-sm lg:text-md relative inline-flex items-center justify-center px-6 lg:px-11 py-2 overflow-hidden font-light text-white transition duration-300 ease-out rounded-full bg-primary-foreground group hover:bg-primary">
