  ...
  return (
    <Link href={link}>
      <div
        ...
        className="text-sm lg:text-md relative inline-flex items-center justify-center px-6 lg:px-11 py-2 overflow-hidden font-light text-primary-foreground transition duration-300 ease-out rounded-full bg-none border-[1px] hover:border-transparent border-primary-foreground group hover:text-white">
